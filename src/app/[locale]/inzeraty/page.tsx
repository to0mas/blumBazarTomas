...
import { Badge, Button, Container, Group, Paper, SimpleGrid, Text } from "@mantine/core";
    ...
    <Container size="xl" my="xl">
      <SimpleGrid cols={{ base: 1, sm: 2, md: 3 }} spacing="md">
        {inzeraty
          .filter((i) => i.nazev)
          .map((i) => {
            const dostupnost = DOSTUPNOST_MAP[i.dostupnost as keyof typeof DOSTUPNOST_MAP] ?? {
              label: "Dostupné",
              color: "green",
            };
